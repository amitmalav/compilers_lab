...
// $insert polymorphicSpecializations
    ...
    template <>
    struct TagOf<SymbolTableEntry*>
    {
        static Tag__ const tag = Tag__::SymbolTableEntry;
    };

    template <>
    struct TagOf<Type*>
    {
        static Tag__ const tag = Tag__::type1;
    };
    ...
    template <>
    struct TypeOfBase<Tag__::RefAst>
    {
        typedef RefAst* DataType;
    };
    ...
    template <>
    struct TypeOfBase<Tag__::SymbolTableEntry>
    {
        typedef SymbolTableEntry* DataType;
    };

    template <>
    struct TypeOfBase<Tag__::type1>
    {
